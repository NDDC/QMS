...
Public Class Login1
    ...
    Private Sub GT()
        ...
        WorkStation.cbSearch.Visible = False
        WorkStation.btnRefresh.Visible = False
        WorkStation.DataGridView1.DataSource = MainClass.Library.Adapter.GetRecordSet("SELECT * FROM VisitorsInfo WHERE POA= '" & txtU.Text & "' and Status= 'NEXT'")

    End Sub

    Private Sub AD()

        WorkStation.cbSearch.Visible = True
        WorkStation.btnRefresh.Visible = True
